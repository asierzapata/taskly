...
exports.createChildWindow = exports.createMainWindow = exports.createWindow = void 0;
const electron_1 = __webpack_require__(/*! electron */ "electron");
// This import will automatically register all modules listeners
__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module './main/modules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
// Handle creating/removing shortcuts on Windows when installing/uninstalling.
if (__webpack_require__(/*! electron-squirrel-startup */ "../../node_modules/electron-squirrel-startup/index.js")) {
    electron_1.app.quit();
}
function createWindow(url, options = {}) {
    const window = new electron_1.BrowserWindow(Object.assign({ width: 700, height: 473 }, options));
...
function createMainWindow() {
    ...
    mainWindow = createWindow('http://localhost:3000/main_window', {
        width: width / 2,
        height: height / 2,
        webPreferences: {
            preload: '/Users/asierzapata/Documents/Projects/taskly-2/apps/desktop/.webpack/renderer/main_window/preload.js'
        }
    });
}
exports.createMainWindow = createMainWindow;
function createChildWindow(url, options = {}) {
    return createWindow(url, Object.assign(Object.assign({}, options), { parent: mainWindow }));
}
