...
const SignInWithGoogle = async ({
	...
	dependencies.shell.openExternal(
		'https://accounts.google.com/o/oauth2/v2/auth?client_id=849674951165-bgplmtbb38oma3jlavkdj12db59bdvgb.apps.googleusercontent.com&redirect_uri=https://taskly-web.vercel.app/auth/google_callback&response_type=code&scope=https://www.googleapis.com/auth/userinfo.email%20https://www.googleapis.com/auth/userinfo.profile'
	)
